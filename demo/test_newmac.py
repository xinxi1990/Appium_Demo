...
# ]
# desiredCapabilities = {'platform': 'Mac','platformName': 'Mac', 'deviceName': 'Mac','cookies': defaultCookies}
...
#             ActionChains(driver).move_to_element_with_offset(parentElement, parentElement.size['width'] - 1,
#                                                              10).perform()
#             ActionChains(driver).move_to_element_with_offset(element, 20, 10).perform()
#         ActionChains(driver).click().perform()
